...
/// <summary>
/// Summary description for XtraReport_chitietphieuban
/// </summary>
public class XtraReport_chitietphieuban : DevExpress.XtraReports.UI.XtraReport
{
    ...
    public XtraReport_chitietphieuban()
    {
        InitializeComponent();
        //
    ...
    public XtraReport_chitietphieuban(int phieu)
    {
        InitializeComponent();
        sqlDataSource1.Queries[0].Parameters[0].Value = phieu;
    }
    /// <summary> 
